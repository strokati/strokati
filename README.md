...
- [**mozAIkas**](https://github.com/strokati/mozaikas) - Evidence-based business idea validation for founders. Is a system that turns an idea into **falsifiable hypotheses**, orchestrates **experiments**, collects **graded evidence** from **real data sources**, and only then produces a **verdict** — go, pivot, or kill.
